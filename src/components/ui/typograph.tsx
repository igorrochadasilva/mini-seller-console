...
export function TypographyH1({ children, className }: TypographyProps) {
  return <h1 className={`scroll-m-20 text-4xl font-extrabold tracking-tight ${className}`}>{children}</h1>;
}

export function TypographyH2({ children, className }: TypographyProps) {
  return <h2 className={`scroll-m-20 text-3xl font-bold tracking-tight ${className}`}>{children}</h2>;
}
...
export function TypographyH5({ children, className }: TypographyProps) {
  return <h5 className={`scroll-m-20 text-lg font-medium tracking-tight ${className}`}>{children}</h5>;
}
